...
import { ClusterPageMenuRegistry, ClusterPageRegistry, KubeObjectDetailRegistry, KubeObjectStatusRegistry, WorkloadsOverviewDetailRegistry } from "../../../extensions/registries";
  ...
  () => {
    ...
    loadInstances(async (extension: LensRendererExtension) => {
      ...
      return disposer(
        ...
        WorkloadsOverviewDetailRegistry.getInstance().add(extension.kubeWorkloadsOverviewItems),
      );
    });
  }
);
