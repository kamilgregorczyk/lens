...
import weblinkStoreInjectableInjectable from "../../../weblinks/store.injectable";
import addComputedSourceInjectable, { AddComputedSource } from "../../entity/add-computed-source.injectable";
...
const syncWeblinkEntitiesInjectable = getInjectable({
  instantiate: (di) => syncWeblinkEntities({
    store: di.inject(weblinkStoreInjectableInjectable),
