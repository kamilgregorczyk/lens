...
const extensionLoadedListenerInjectable = implWithOn(extensionLoadedInjectionToken, (di) => {
  ...
  const extensionsLoadedOnRenderer = di.inject(rendererExtensionsLoadedInjectable);
